...
from dynofuzz.cli.model_exec import verify_testcase
from dynofuzz.error import InternalError
from dynofuzz.filter import FILTERS
from dynofuzz.gir import GraphIR
from dynofuzz.graph_gen import model_gen
from dynofuzz.logging import FUZZ_LOG
from dynofuzz.macro import NNSMITH_BUG_PATTERN_TOKEN
from dynofuzz.materialize import Model, TestCase
from dynofuzz.narrow_spec import auto_opset
from dynofuzz.util import mkdir, parse_timestr, set_seed
...
class FuzzingLoop:
    def __init__(
        ...
        if (
            ...
            raise ValueError("Please set `fuzz.crash_safe=false` for XLA on CUDA. ")
