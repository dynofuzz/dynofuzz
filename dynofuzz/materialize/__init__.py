...
class Model(ABC):
    ...
    def init(name, backend_target=None) -> Type["Model"]:
        ...
        if name == "torch":
            ...
            # device agnoistic
            from dynofuzz.materialize.onnx import ONNXModel

            return ONNXModel
        elif name == "tensorflow":
            from dynofuzz.materialize.tensorflow import TFModelCPU, TFModelGPU
