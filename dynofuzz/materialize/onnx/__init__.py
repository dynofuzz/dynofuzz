...
from dynofuzz.abstract.op import AbsTensor
from dynofuzz.gir import GraphIR
from dynofuzz.macro import onnx2external_data_dir
from dynofuzz.materialize.torch import SymbolNet, TorchModel
...
def create_deadcode_onnx(onnx_model: onnx.ModelProto, name_mask) -> onnx.ModelProto:
    ...
    model_def = onnx.helper.make_model(
        graph=graph_def, producer_name="dynofuzz.deadcode"
    )
