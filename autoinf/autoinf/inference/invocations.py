...
from autoinf.instrument.utils import get_ret_list, tensors_from_numpys


def inst_invocations(inst: OpInstance, type="success"):
...
def input_validity_test(inst: OpInstance, inputs):
